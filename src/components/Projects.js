...
export default function Projects() {
    return (
        <div>
            ...
            ></div>
                <p>
                    15 Minutes was built using the Twitter API.  It's an app with a unique take on the concept introduced by Andy Warhol; "15 Minutes of Fame".  
                    ...
                    <a href="https://calm-citadel-32694.herokuapp.com/">Check out the app here.</a>
                </p>
        </section>
        </div>
    )
